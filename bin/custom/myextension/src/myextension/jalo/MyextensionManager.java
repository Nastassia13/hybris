...
public class MyextensionManager extends GeneratedMyextensionManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(MyextensionManager.class);
	...
	{
		return (MyextensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MyextensionConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of MyextensionManager called, current tenant: {}", getTenant().getTenantID());
	}
